...
<div id="contenedor">
            ...
            <div class="col-md-12">
                <div class="panel panel-visible ph10" id="spy2">
                    ...
                    <div style="margin-bottom: 20px; text-align: center ">
                        {{--
                        <span __submenu="0" class="submenu ">
                            Noticias
                        </span>
                        <span __submenu="1" class="submenu ">
                            Promociones
                        </span>
                        --}}
                    </div>
                    ...
                    <div class="panel-body pn">
                        <div class="row">
                            <div class="col-md-12">
                                <button __accion="nuevo" class="btn btn-sm btn-success dark m5 br4">
                                    <i class="fa fa-plus-circle text-white">
                                    </i>
                                    Agregar
                                </button>
                                <button __accion="editar" class="btn btn-sm btn-warning dark m5 br4">
                                    <i class="fa fa-edit text-white">
                                    </i>
                                    Editar
                                </button>                                
                                <button __accion="eliminar" class="btn btn-sm btn-danger dark m5 br4">
    ...
    <!-- end: .tray-center -->
    <!-- -----------------------------------------          Modal  --------------------------------------------------- -->
    <div class="white-popup-block popup-basic admin-form mfp-with-anim mfp-hide" id="modal">
        <div class="panel">
            <div class="panel-heading bg-dark">
                <span class="panel-title text-white" id="tituloModal">
            ...
            <form action="/" id="form_cont" method="post" name="form_cont">
                        ...
                        <div class="row">
                            <div class="row">
                                <div class=" pl5 br-r mvn15">
                                    ...
                                    <input __field="id" class="hidden" id="id" name="id">
                                        <div class="section">
                                            <label class="field-label" for="titulo">
                                                Título
                                            </label>
                                            <label class="field prepend-icon" for="titulo">
                                                <input __field="titulo" class="gui-input" id="titulo" name="titulo" placeholder="Título" required="" type="text">
                                                    <label class="field-icon" for="titulo">
                                                        <i class="glyphicons glyphicons-riflescope">
                                                        </i>
                                                    </label>
                                                </input>
                                            </label>
                                        ...
                                        <div class="section">
                                            <label class="field-label" for="texto">
                                                Texto
                                            </label>
                                            <label class="field prepend-icon" for="texto">
                                                <textarea __field="texto" class="gui-textarea" id="texto" name="texto" placeholder="Texto" required="" rows="2">
                                                </textarea>
                                                <label class="field-icon" for="texto">
                                                    <i class=" glyphicons glyphicons-notes">
                                                    </i>
                                                </label>
                                            </label>
                                        </div>
                                        ...
                                        <div class="section">
                                            ...
                                            <label class="field prepend-icon" for="url_redireccion">
                                                <input __field="url_redireccion" class="gui-input" id="url_redireccion" name="url_redireccion" placeholder="Url de link" type="text">
                                                    <label class="field-icon" for="url_redireccion">
                                                        <i class="fa fa-link">
                                                        </i>
                                                    </label>
                                                </input>
                                        ...
                                        <div class="row m10 ml20 ">
                                            <label class="switch switch-sm block mt5 switch-success switch-round ">
                                                ...
                                                <input __field="activo" id="activo" name="activo" type="checkbox" value="">
                                                    <label class="fs11" data-off="NO" data-on="SI" for="activo">
                                                    </label>
                                                </input>
                                            </label>
                                        </div>
                    ...
                    <div class="panel-footer">
                        <button class="button btn-primary cont_save" type="submit">
                            Guardar
                        </button>
                        <a class="button btn-danger ml25 cont_cancelar" href="#" id="atr_cancelar">
                            Cancelar
                        </a>
                    </div>
                </form>
...
@push('script-head')
<script src="./public/libs_pub/jqwidgets11/jqxcore.js" type="text/javascript"></script>
<script src="./public/libs_pub/jqwidgets11/jqxbuttons.js" type="text/javascript"></script>
<script src="./public/libs_pub/jqwidgets11/jqxscrollbar.js" type="text/javascript"></script>
<script src="./public/libs_pub/jqwidgets11/jqxdata.js" type="text/javascript"></script>
<script src="./public/libs_pub/jqwidgets11/jqxdatatable.js" type="text/javascript"></script>
<script src="./public/libs_pub/jqwidgets11/jqxdraw.js" type="text/javascript"></script>
<script src="./public/libs_pub/jqwidgets11/jqxchart.core.js" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    let conT = {
        ...
        getData: function(){        
            ...
            objeto.tipo_contenido = $scope.data[$scope.indice].id_tipo_noticia; /* id del parametro que contiene el tipo_contenido*/
